...
class X509SkiGeneratorHelper {
    
    /// Parses a Base64-encoded X.509 certificate string and returns a SecCertificate object.
    static func parseCertificateFromBase64(_ base64Cert: String) -> SecCertificate? {
    ...
    @available(iOS 14.0, *)
    static func generateSkiString(cert: SecCertificate) -> String? {
    ...
    @available(iOS 14.0, *)
    static func extractPublicKeyBase64(from cert: SecCertificate) -> String? {
        guard let publicKey = extractPublicKey(cert: cert),
              let publicKeyData = SecKeyCopyExternalRepresentation(publicKey, nil) as Data? else {
            return nil
        }
    ...
    static func extractBase64PublicKey(from x5cBase64: String) -> String? {
    ...
    static func generateSKI(from x5cCertificateBase64: String) -> String? {
