...
enum CredentialViewType {
    case detail
    case history
    case other
}

final class ReceiptViewController: UIViewController, CustomNavigationBarIconViewDelegate, NavigationHandlerProtocol {
...
extension ReceiptViewController: ReceiptItemViewModelDelegate {
...
//extension ReceiptViewController: PKPassAdditionalDetailViewControllerDelegate {
//    
//    func clearCache() {
