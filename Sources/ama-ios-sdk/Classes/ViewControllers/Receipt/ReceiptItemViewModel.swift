//
//  ReceiptItemViewModel.swift
//  dataWallet
//
//  Created by iGrant on 14/05/25.
//
...
protocol ReceiptItemViewModelDelegate: AnyObject {
    func dismiss()
}

final class ReceiptItemViewModel {
    
    var model: ReceiptItemModel?
